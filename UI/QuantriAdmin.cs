...
namespace Quan_Ly_Dien_Thoai.UI
{
    public partial class QuantriAdmin : Form
    {
        ...
        String[] display_elements_NV = { "Mã nhân viên", "Tên nhân viên", "Tên đăng nhập", "Mật khẩu", "Loại nhân viên" };
        String[] display_elements_NCC = { "Mã nhà cung cấp", "Tên nhà cung cấp", "Số điện thoại" };
        ...
        {
            if (NCC.timPNtheoNCC(txtMaNCC.Text))
            {
                MessageBox.Show("Nhà cung cấp này đã có phiếu nhập. Không thể xoá");
                return;
            }
        ...
        {
            xuly.GenerateHTMLFromXML1("NHANVIEN.xml", "NHANVIEN", colnames_elements_NV,display_elements_NV, "NHANVIEN.html", "Danh sách nhân viên");
        }

        private void btnXmlViewer_NCC_Click(object sender, EventArgs e)
        {
            xuly.GenerateHTMLFromXML1("NHACUNGCAP.xml", "NHACUNGCAP", colnames_elements_NCC,display_elements_NCC, "NHACUNGCAP.html", "Danh sách nhà cung cấp");
        }
